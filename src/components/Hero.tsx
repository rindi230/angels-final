...
export const Hero = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=2070&q=80')`
      }}
    >
      ...
      <div className="text-center text-white animate-fade-in relative z-10 max-w-4xl mx-auto px-4">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto px-4 font-light">
          Welcome to Angels Fitness Gym - Where Champions Are Made
        </p>
        
        <p className="text-lg mb-12 max-w-xl mx-auto px-4 opacity-90">
          Join our community of fitness enthusiasts and discover your strongest self with expert guidance and state-of-the-art equipment.
        </p>
        ...
        >
          <div className="relative w-full max-w-6xl mx-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="aspect-video bg-gray-900 rounded-lg overflow-hidden">
              ...
              >
                <source src="/gym-photos/video.mp4" type="video/mp4" />
